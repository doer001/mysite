...
class RegisterForm(forms.Form):
    username = forms.CharField(label='用户名', min_length=3, max_length=32, widget=forms.TextInput(
                                attrs={'class': 'form-control', 'placeholder': '请输入3-32位用户名'}))
    password1 = forms.CharField(label='密码', min_length=6, max_length=256, widget=forms.PasswordInput(
                                attrs={'class': 'form-control', 'placeholder': '请输入至少6位密码'}))
    password2 = forms.CharField(label='确认密码', min_length=6, max_length=256, widget=forms.PasswordInput(
    ...
    verification_code = forms.CharField(label='验证码', required=False, widget=forms.TextInput(
                                        attrs={'class': 'form-control', 'placeholder': "填写从邮箱收到的验证码"}))
...
class ChangeNicknameForm(forms.Form):
    nickname_new = forms.CharField(label='新昵称', max_length=32,
...
class BindEmailForm(forms.Form):
    ...
    verification_code = forms.CharField(label='验证码', required=False, widget=forms.TextInput(
                                        attrs={'class': 'form-control', 'placeholder': "填写邮箱收到的验证码"}))
...
class ChangePasswordForm(forms.Form):
    old_password = forms.CharField(label='旧密码', min_length=6, max_length=256, widget=forms.PasswordInput(
                                attrs={'class': 'form-control', 'placeholder': '请输入原密码'}))
    new_password = forms.CharField(label='新密码', min_length=6, max_length=256, widget=forms.PasswordInput(
                                attrs={'class': 'form-control', 'placeholder': '请输入新密码，至少6位'}))
    new_password_again = forms.CharField(label='确认密码', min_length=6, max_length=256, widget=forms.PasswordInput(
...
class ForgotPasswordForm(forms.Form):
    ...
    new_password = forms.CharField(label='新密码', required=False, widget=forms.TextInput(
